                      ...
                      <tbody>                      
                        ...
                        <tr>
                          ...
                          <td>{{$list->post_date}}</td>
                           <td>
                            <a type="button" class="btn btn-info color_white" href="{{url('admin/post/edit/'.$list->id)}}">Info</a>
                            <a type="button" class="btn btn-danger color_white" href="{{url('admin/post/delete/'.$list->id)}}">Delete</a>
                          </td>                                             
                        </tr>
                        @endforeach 
                      </tbody>
